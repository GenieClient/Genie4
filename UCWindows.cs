    ...
    public partial class UCWindows
    {
        ...
        public void PopulateList()
        {
            if (!Information.IsNothing(m_FormMain))
            {
                ...
                li.SubItems.Add(m_FormMain.OutputMain.HideScrollbars.ToString()); // Hide/Show scrollbars
                ...
                while (myEnumerator.MoveNext())
                {
                    ...
                    li.SubItems.Add(tmpFormSkin.HideScrollbars.ToString()); // Hide/Show scrollbars
                    li.Tag = tmpFormSkin;
                }
            }
        }
        ...
        private void ResetList()
        {
            ...
            ListViewBase.Columns.Add("Name List Only", 95, HorizontalAlignment.Left);
            ListViewBase.Columns.Add("Show Scrollbars", 95, HorizontalAlignment.Left);
        }
        ...
        private void UpdateGroupBox()
        {
            ...
            if (ListViewBase.SelectedItems.Count == 1)
            {
                if (!Information.IsNothing(ListViewBase.SelectedItems[0].Tag))
                {
                    ...
                    CheckBoxHideScrollbars.Enabled = true; // Hide/Show scrollbars
                    ...
                    CheckBoxHideScrollbars.Checked = fo.HideScrollbars; // Hide/Show scrollbars
        ...
        private void ListWasUnselected()
        {
            ...
            CheckBoxTimeStamp.Checked = false;
            CheckBoxNameListOnly.Checked = false;
            CheckBoxHideScrollbars.Checked = true; // Hide/Show scrollbars
        ...
        public bool ApplyChanges()
        {
                ...
                foreach (ListViewItem li in (ArrayList)GroupBoxBase.Tag)
                {
                    if (!Information.IsNothing(li.Tag))
                    {
                        ...
                        if (TextBoxTitle.Enabled == true) // Single edit
                        {
                            ...
                            fo.HideScrollbars = CheckBoxHideScrollbars.Checked; // Hide/Show scrollbars
                            li.SubItems[3].Text = CheckBoxTimeStamp.Checked.ToString();
                            li.SubItems[4].Text = CheckBoxNameListOnly.Checked.ToString();
                            li.SubItems[5].Text = CheckBoxHideScrollbars.Checked.ToString(); // Hide/Show scrollbars
                        }
            ...
            else // New
            {
                ...
                if (!Information.IsNothing(fo))
                {
                    ...
                    li.SubItems.Add(fo.HideScrollbars.ToString()); // Hide/Show scrollbars
                    li.Tag = fo;
                    li.Selected = true;
                    ToolStripButtonRemove.Enabled = true;
                    RemoveToolStripMenuItem.Enabled = true;
...
#pragma warning restore CS0168
        ...
        private void CheckBoxHideScrollbars_CheckedChanged(object sender, EventArgs e) // Hide/Show scrollbars
        {
            m_ItemChanged = true;
        }
