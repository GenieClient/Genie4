...
namespace GenieClient
{
    public class Utility
    {
        ...
        public static string ArrayToString(ThreadedArrayList oList)
        {
        ...
        public static ThreadedArrayList ParseArgs(string sText, bool bTreatUnderscoreAsSpace = false)
        {
            ThreadedArrayList oList = new ThreadedArrayList();
            try
            {
        ...
        public static void AddArrayItem(ThreadedArrayList oList, string sText, bool bTreatUnderscoreAsSpace = false)
        {
            if (sText.StartsWith("\""))
            {
                if (sText.EndsWith("\""))
    ...
    /// <returns>File.GetLastWriteTime, or DateTime.MaxValue if exception was encountered.</returns>
        ...
        public static string ArrayToString(ThreadedArrayList oList, int iStartIndex)
        {
        ...
        public static ThreadedArrayList SafeSplit(string sInput, char cSplitChar)
        {
            var oList = new ThreadedArrayList();
            bool bInsideString = false;
            var cInsideStringChar = default(char);
            int iBracketDepth = 0;
