...
namespace GenieClient
{
    ...
    public partial class UCMacros : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _TextBoxMacro.KeyPress += new KeyPressEventHandler(TextBoxMacro_KeyPress);
            _TextBoxMacro.TextChanged += new EventHandler(TextBox_TextChanged);
            _TextBoxMacro.KeyDown += new KeyEventHandler(TextBoxMacro_KeyDown);
            _LabelMacro = new Label();
            ...
            _TextBoxAction.Size = new Size(397, 20);
            ...
            _GroupBoxBase.Controls.Add(_TextBoxMacro);
            _GroupBoxBase.Controls.Add(_LabelMacro);
            ...
            // ButtonEdit
            // 
            _ButtonEdit.Image = My.Resources.Resources.accessories_text_editor;
            _ButtonEdit.Location = new Point(567, 31);
            _ButtonEdit.Name = "ButtonEdit";
            _ButtonEdit.Size = new Size(23, 23);
            ...
            // TextBoxMacro
            // 
            _TextBoxMacro.Location = new Point(6, 32);
            _TextBoxMacro.Name = "TextBoxMacro";
            _TextBoxMacro.Size = new Size(152, 20);
            _TextBoxMacro.TabIndex = 1;
            // 
            // LabelMacro
            // 
            _LabelMacro.AutoSize = true;
            _LabelMacro.Location = new Point(3, 16);
            _LabelMacro.Name = "LabelMacro";
            _LabelMacro.Size = new Size(98, 13);
            _LabelMacro.TabIndex = 8;
            _LabelMacro.Text = "Macro (Press Keys)";
            // 
            // FontDialogPicker
            // 
